                    ...
                    <div class="tile">
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable1">
                            ...
                            <tbody>
                                ...
                                require '../dbh/dbh.php';
                                $sql = "SELECT * FROM coaches,coache_sporting WHERE coaches.Member_No = coache_sporting.Member_No";
                                $result = mysqli_query($Conn,$sql);
                                $confirm = mysqli_num_rows($result);
                                if ($confirm >0 )
                                {
                                    while ($row = mysqli_fetch_assoc($result))
                                    {
                                          echo "<tr>".
                                                    ...
                                                    "<td>".$row['Province']."</td>".
                                                    "<td>".$row['Coaching_position']."</td>".
                                                    "<td>".$row['Previous_Club']."</td>".
                                                    "<td>".$row['Previous_Club_Province']."</td>".
                                                    "<td>".$row['Previous_coaching_position']."</td>".
                                              "</tr>";
                                    }
                                }
                                ?>
                    ...
                    <div class="tile">
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable2">
                            ...
                            <tbody>
                                ...
                                require '../dbh/dbh.php';
                                $sql = "SELECT * FROM coaches,coaching_qualification WHERE coaches.Member_No = coaching_qualification.Member_No";
                                $result = mysqli_query($Conn,$sql);
                                $confirm = mysqli_num_rows($result);
                                if ($confirm >0 )
                                {
                    ...
                    <div class="tile">
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable3">
                            ...
                            <tbody>
                                ...
                                require '../dbh/dbh.php';
                                $sql = "SELECT * FROM coaches,provincial_team_assignment WHERE coaches.Member_No = provincial_team_assignment.Member_No";
                                $result = mysqli_query($Conn,$sql);
                                $confirm = mysqli_num_rows($result);
                                if ($confirm >0 )
                                {
                ...
                <div class="container-fluid">
                    <nav>
                        <ul class="footer-menu">
                            ...
                            <li>
                                <button type = "button" onclick= "sporting()" class = "btn btn-default">Provincial Team Assignments</button>
                            </li>
                            <li>
                                <button type = "button" onclick= "ntaaa()" class = "btn btn-default">National Team Assignments</button>
                            </li>
                            <li>
                                <button type = "button" onclick = "education()" class = "btn btn-default">History</button>
                            </li>
                        </ul>
