...
{
    document.getElementById('more-details').style.display = "contents";
    ...
    document.getElementById('sportsdetails').style.display = "none";
    
}
function basicdetails()
{
    document.getElementById('basic').style.display = "contents";
...
{
    document.getElementById('p_info').style.display = "contents";
    document.getElementById('more-details').style.display = "none";
    document.getElementById('basic').style.display = "none";
    document.getElementById('healthdetails').style.display = "none";
    document.getElementById('educationdetails').style.display = "none";
...
{
    document.getElementById('educationdetails').style.display = "contents";
    document.getElementById('more-details').style.display = "none";
    document.getElementById('basic').style.display = "none";
    document.getElementById('p_info').style.display = "none";
    document.getElementById('healthdetails').style.display = "none";
...
{
    document.getElementById('sportsdetails').style.display = "contents";
    document.getElementById('more-details').style.display = "none";
    document.getElementById('basic').style.display = "none";
    document.getElementById('p_info').style.display = "none";
    document.getElementById('educationdetails').style.display = "none";
...
{
    document.getElementById('healthdetails').style.display = "contents";
    document.getElementById('more-details').style.display = "none";
    document.getElementById('basic').style.display = "none";
    document.getElementById('p_info').style.display = "none";
    document.getElementById('educationdetails').style.display = "none";
...
function info()
{
    document.getElementById('players').style.display = "contents";
...
function proffession()
{
    ...
    document.getElementById('prof').style.display = "contents";
    document.getElementById('health_info').style.display = "none";
    document.getElementById('sporting').style.display = "none";
    document.getElementById('education').style.display = "none";
}
